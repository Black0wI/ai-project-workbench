...
REQUIRED_FILES=(
  ...
  ".skills/README.md"
  "context/README.md"
  "context/obsidian/README.md"
  "context/obsidian/vault.example/README.md"
  "context/obsidian/templates/project-note.md"
  "context/obsidian/templates/decision-note.md"
  "context/obsidian/templates/meeting-note.md"
  "context/obsidian/templates/research-note.md"
  "context/obsidian/templates/prompt-note.md"
  "context/obsidian/exports/.gitkeep"
  "prompts/README.md"
  "evals/README.md"
  ...
  "docs/runbooks/obsidian-context.md"
  ...
  "docs/adr/0008-optional-obsidian-context.md"
